...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.main-layout','data' => ['title' => 'Learniverse - Tambah Modul']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Learniverse - Tambah Modul']); ?>
    <main class="pt-28 pb-10 container">
        <div class="max-w-2xl mx-auto">
            ...
            <form action="<?php echo e(route('subjects.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div class="grid gap-1">
                        ...
                        <input type="text" name="level" id="level" value="<?php echo e(old('level')); ?>"
                            class="py-2 px-4 rounded border focus:outline-none">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\wabw\LearnDhis\resources\views/subjects/create.blade.php ENDPATH**/ ?>