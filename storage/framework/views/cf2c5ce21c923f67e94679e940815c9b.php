...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-layout','data' => ['title' => 'Learniverse - Login']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Learniverse - Login']); ?>
    <form action="<?php echo e(route('authenticate')); ?>" method="POST" class="max-w-sm bg-white p-8 rounded-lg mx-auto">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        <?php if(session()->has('success_register')): ?>
            <div class="py-2 px-4 rounded bg-green-100 text-green-600 mb-4 border border-green-600">
                <?php echo e(session('success_register')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\wabw\LearnDhis\resources\views/auth/login.blade.php ENDPATH**/ ?>